...
contract EmobitsArtInstall {
    ...
    function _addBackgrounds() internal {
        ...
        placeholder[0] =
            IBBitsEmoji.NamedBytes({core: '<rect width="21" height="21" fill="#0052FF"/>', name: "Base Onchain Summer"});
    ...
    function _addMouths() internal {
        IBBitsEmoji.NamedBytes[] memory placeholder = new IBBitsEmoji.NamedBytes[](1);
        placeholder[0] = IBBitsEmoji.NamedBytes({core: '<path d="M9 14V13H12V14H9Z" fill="#FF8DCF"/>', name: "snub"});
