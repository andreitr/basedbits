...
contract LuckyGhoulsArt {
    ...
    /// @dev Same image for every tokenId
    function generateSVG(uint256) public pure returns (string memory) {
        return '<svg width="480" height="480" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#EA9412"/><path d="M19 9H24H29V10H31V11H32V10H33V9H34V6H35H36V7H37V9H38V13H37V15H36V18H37V19H38V18H39V17H40H41V23H40V26H39V28H38V29.5H37V31H35V30H34V31V32H33V34H32V37H31V38H30V39H29V41H28V42H27V43H21V42H20V41H19V39H18V38H17V37H16V34H15V32H14V30H13V31H11V30H10V28H9V26H8V23H7V17H8H9V18H10V19H11V18H12V15H11V13H10V9H11V7H12V6H14V9H15V10H16V11H17V10H19V9Z" fill="white"/><path d="M18 30H19V31H20H21V32H22V31H23V32H24H25V31H26V32H27V31H28H29V30H30V29H34V30H32V31H31V34H30V36H29V37H28V38H20V37H19V36H18V34H17V31H16V30H14V29H18V30Z" fill="#EA9412"/><path d="M23 26V25H25V26H26V29H25V28H23V29H22V26H23Z" fill="#EA9412"/><path d="M19 31H20V34H19V31Z" fill="white"/><path d="M28 31H29V34H28V31Z" fill="white"/><path d="M19 31H20V33H19V31Z" fill="white"/><path d="M28 31H29V33H28V31Z" fill="white"/><path d="M20 36H21V38H20V36Z" fill="white"/><path d="M22 37H26V38H22V37Z" fill="white"/><path d="M27 36H28V38H27V36Z" fill="white"/><path d="M21.006 31.994L22.006 32.006L21.994 33.006L20.994 32.994L21.006 31.994Z" fill="white"/><path d="M23 32H25V33H23V32Z" fill="white"/><path d="M24 32H25V33H24V32Z" fill="white"/><path d="M20 37H21V38H20V37Z" fill="white"/><path d="M23 37H25V38H23V37Z" fill="white"/><path d="M27 37H28V38H27V37Z" fill="white"/><path d="M26 32H27V33H26V32Z" fill="white"/><path d="M13 24V20H14V19H15V18H16V17H20V18H21V19H22V20H23V24H22V25H21V26H20V27H16V26H15V25H14V24H13Z" fill="#EA9412"/><rect x="17" y="21" width="1" height="1" fill="white"/><path d="M25 24V20H26V19H27V18H28V17H32V18H33V19H34V20H35V24H34V25H33V26H32V27H28V26H27V25H26V24H25Z" fill="#EA9412"/><rect x="29" y="21" width="1" height="1" fill="white"/></svg>';
    }
}
